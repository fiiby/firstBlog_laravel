    ...
    <div class="container">
        ...
        <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="mx-auto w-1/2">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="title" class="form-input mt-1 block w-full" value="{{ $task->name }}">
            </div>
            <div class="mb-4">
                <label for="completed" class="block text-gray-700">Completed</label>
                <input type="hidden" name="completed" value="0">
                <input type="checkbox" name="completed" id="completed" class="form-checkbox mt-1 block" value="1" {{ $task->completed ? 'checked' : '' }}>
            </div>
            <div class="mb-4">
